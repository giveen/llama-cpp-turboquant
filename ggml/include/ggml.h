...
GGML_DEPRECATED(GGML_API struct ggml_tensor * ggml_add1(struct ggml_context * ctx,
                                                        struct ggml_tensor *  a,
                                                        struct ggml_tensor *  b),
                "use ggml_add instead");

GGML_DEPRECATED(GGML_API struct ggml_tensor * ggml_add1_inplace(struct ggml_context * ctx,
                                                                struct ggml_tensor *  a,
                                                                struct ggml_tensor *  b),
...
GGML_API void ggml_mul_mat_set_hint(struct ggml_tensor * a, enum ggml_op_hint hint);
...
GGML_API struct ggml_tensor * ggml_col2im_1d(struct ggml_context * ctx,
...
GGML_API void ggml_flash_attn_ext_set_n_kv_max(struct ggml_tensor * a, int32_t n_kv_max);
...
GGML_API struct ggml_tensor * ggml_gated_delta_net(struct ggml_context * ctx,
                                                   struct ggml_tensor *  q,
                                                   struct ggml_tensor *  k,
                                                   struct ggml_tensor *  v,
                                                   struct ggml_tensor *  g,
...
GGML_API struct ggml_tensor * ggml_kvarn_seal(struct ggml_context * ctx,
...
GGML_API struct ggml_tensor * ggml_kvarn_materialize(struct ggml_context * ctx,
...
GGML_API struct ggml_tensor * ggml_kvarn_attn_decode(struct ggml_context * ctx,
                                                     struct ggml_tensor *  q,
                                                     struct ggml_tensor *  sealed,
                                                     struct ggml_tensor *  k_tail,
                                                     struct ggml_tensor *  v_tail,
...
GGML_API struct ggml_tensor * ggml_kvarn_cpy(struct ggml_context * ctx,
...
GGML_API struct ggml_tensor * ggml_lightning_indexer(struct ggml_context * ctx,
                                                     struct ggml_tensor *  q,
                                                     struct ggml_tensor *  k,
...
GGML_API struct ggml_tensor * ggml_dsv4_hc_comb(struct ggml_context * ctx,
...
//
GGML_API struct ggml_tensor * ggml_dsv4_hc_pre(struct ggml_context * ctx,
                                               struct ggml_tensor *  x,
                                               struct ggml_tensor *  weights);
...
//
GGML_API struct ggml_tensor * ggml_dsv4_hc_post(struct ggml_context * ctx,
                                                struct ggml_tensor *  x,
...
GGML_API void ggml_build_forward_order(struct ggml_cgraph * cgraph, struct ggml_tensor * tensor);
