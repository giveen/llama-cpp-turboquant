...
static void ggml_vec_dot_turbo4_0_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
static void ggml_vec_dot_oscar2_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc);
...
// OSCAR2 vec_dot: dequantize oscar2 block to f32, then dot with f32 operand.
static void ggml_vec_dot_oscar2_f32(int n, float * GGML_RESTRICT s, size_t bs,
                                       const void * GGML_RESTRICT vx, size_t bx,
                                       const void * GGML_RESTRICT vy, size_t by, int nrc) {
    GGML_ASSERT(nrc == 1);
    ...
    float * tmp = (float *)malloc(n * sizeof(float));
    GGML_ASSERT(tmp != NULL);
    ggml_get_type_traits(GGML_TYPE_OSCAR2)->to_float(vx, tmp, n);
