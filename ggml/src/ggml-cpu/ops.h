...
void ggml_compute_forward_kvarn_seal(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_kvarn_materialize(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_kvarn_attn_decode(const struct ggml_compute_params * params, struct ggml_tensor * dst);
void ggml_compute_forward_kvarn_cpy(const struct ggml_compute_params * params, struct ggml_tensor * dst);
