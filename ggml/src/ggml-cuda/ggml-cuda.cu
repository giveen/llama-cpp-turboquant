    ...
    switch (op->op) {
        ...
        case GGML_OP_SET_ROWS:
            {
                ...
                return (
                           (
                               ...
                               op->type == GGML_TYPE_TURBO3_0 || op->type == GGML_TYPE_TURBO2_0 || op->type == GGML_TYPE_TURBO4_0 || op->type == GGML_TYPE_OSCAR2) &&
        ...
        case GGML_OP_CPY:
            {
                ...
                if (src0_type == GGML_TYPE_F32 && src1_type == GGML_TYPE_OSCAR2) {
                    return true;
                }
                if (src0_type == GGML_TYPE_OSCAR2 && src1_type == GGML_TYPE_F32) {
                    return true;
                }
        ...
        case GGML_OP_DSV4_HC_POST:
            return op->src[0]->type == GGML_TYPE_F32 && op->src[1]->type == GGML_TYPE_F32 &&
                ...
                op->type == GGML_TYPE_F32;
        case GGML_OP_FLASH_ATTN_EXT:            return ggml_cuda_flash_attn_ext_supported(dev_ctx->device, op);
        case GGML_OP_CROSS_ENTROPY_LOSS:
        case GGML_OP_CROSS_ENTROPY_LOSS_BACK:
        case GGML_OP_OPT_STEP_ADAMW:
        case GGML_OP_OPT_STEP_SGD:
